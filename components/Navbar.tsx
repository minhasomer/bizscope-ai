...
export const Navbar: React.FC<NavbarProps> = ({ onNavigate, currentPage, currentPlan, user, onSignOut, authLoading = false }) => {
  ...
  return (
    <nav className="bg-slate-100 backdrop-blur-sm border-b border-slate-300 shadow-[0_1px_6px_rgba(0,0,0,0.10)] sticky top-0 z-40 overflow-x-hidden" ref={mobileMenuRef}>
